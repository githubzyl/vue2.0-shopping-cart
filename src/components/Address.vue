    ...
    <div class="container">
      <div class="checkout-addr">
        ...
        <div class="addr-list-wrap">
          <div class="addr-list">
            <ul>
              <li v-for="(item, index) in filterAddress" v-bind:class="{'check': index === currIndex}" @click="currIndex=index">
                <dl>
                  <dt>{{ item.userName }}</dt>
        ...
        <div class="md-modal modal-msg md-modal-transition" id="showModal" :class="{'md-show': delShow}">
          <div class="md-modal-inner">
            <div class="md-top">
              <button class="md-close" @click="delShow = false">关闭</button>
            </div>
            <div class="md-content">
              ...
              <div class="btn-wrap col-2">
                ...
                <button class="btn btn--m btn--red" id="btnModalCancel" @click="delShow = false">No</button>
              </div>
            </div>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      */
      ...
      delAddress: function () {
        let index = this.addressList.indexOf(this.currItem)
